            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-3">
                                <img src="<?= base_url('dist') ?>/assets/img/avatar/<?= $user['foto']; ?>" alt="<?= $user['nama_user']; ?>" class="rounded-circle shadow-sm img-thumbnail">
                            </div>
                            <div class="col-9">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_user', $user['nama_user']); ?>" name="nama_user" id="nama" type="text" class="form-control" placeholder="Nama Anda...">
                        </div>
