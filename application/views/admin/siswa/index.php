              ...
              <tbody>
                <?php $no = 1; foreach($siswa as $g) : ?>
                  <tr>
                    ...
                    <td><?= $g['biaya']; ?></td>
                    <td>
                      <a href="<?= base_url('dashboard/sendwa/') . $g['id_siswa']; ?>" class="btn btn-success"><i class="fa fa-whatsapp"></i></a>
                      <a href="<?= base_url('dashboard/ubahSiswa/') . $g['id_siswa']; ?>" class="btn btn-primary">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a href="<?= base_url('dashboard/siswa_delete/') . $g['id_siswa']; ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus ?')"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="tahun_ajaran" id="tahun_ajaran" value="2023/2024" class="form-control">
          <small class="muted text-danger"><?= form_error('tahun_ajaran'); ?></small>
        </div>
        <div class="form-group">
          <label for="biaya">biaya</label>
          <input type="number" name="biaya" id="biaya" value="150000" class="form-control">
          <small class="muted text-danger"><?= form_error('biaya'); ?></small>
        </div>
        <div class="form-group">
          <label for="jatuh_tempo">Jatuh Tempo Pertama</label>
          <input type="date" name="jatuh_tempo" id="jatuh_tempo" value="2023-07-10"  class="form-control">
