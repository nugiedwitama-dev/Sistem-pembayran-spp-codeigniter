...
<head>
  ...
  <title>
    <?= $title;?> - Sistem Pembayaran SPP PKBM Budi Utama
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-start ms-2 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'siswa') ? 'active' : ''?>" href="<?= base_url('dashboard/siswa');?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'billing') ? 'active' : ''?>" href="<?= base_url('dashboard/billing')?>">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'laporan') ? 'active' : ''?>" href="<?= base_url('dashboard')?>/laporan">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'spp') ? 'active' : ''?>" href="<?= base_url('dashboard')?>/spp">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'guru') ? 'active' : ''?>" href="<?= base_url('dashboard')?>/guru">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'kelas') ? 'active' : ''?>" href="<?= base_url('dashboard')?>/wali">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
          <a class="nav-link <?= ($current_page == 'user_management') ? 'active' : ''?>" href="<?= base_url('dashboard')?>/user_management">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                        <a href="<?= base_url()?>/dashboard/setting"><i class="fas fa-edit"> Edit Profil</i></a>
                  </a>
                </li>
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                        <a href="/profile">
                          <i class="fas fa-eye"> Lihat Profil</i>
                        </a>
                  </a>
                </li>
                <li>
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                        <a href="ubahpassword"><i class="fas fa-key"> Ubah Password</i></a>
                  </a>
                </li>
                <li>
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                        <a href="<?= base_url()?>/auth/logout"><i class="fa fa-sign-out"> Log Out</i></a>
                  </a>
                </li>
              </ul>
          </li>
          ...
          <li class="nav-item px-3 d-flex align-items-center">
              <a href="<?= base_url('dashboard')?>/profile" class="nav-link text-white p-0">
